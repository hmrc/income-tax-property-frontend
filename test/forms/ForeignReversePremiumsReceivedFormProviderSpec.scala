...
class ForeignReversePremiumsReceivedFormProviderSpec  extends BooleanFieldBehaviours with OptionValues {

  val requiredKey = "reversePremiumsReceived.error.required.individual"
  val invalidKey = "error.boolean"

  val form = new ForeignReversePremiumsReceivedFormProvider()("individual")
