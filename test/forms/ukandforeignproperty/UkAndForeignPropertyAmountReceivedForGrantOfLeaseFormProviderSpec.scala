...
class UkAndForeignPropertyAmountReceivedForGrantOfLeaseFormProviderSpec extends CurrencyFieldBehaviours {

  val requiredKey = "ukAndForeignPropertyRentalTypeUk.amountReceivedForGrantOfLease.amount.error.required"
  ...
  forAll(scenarios) { (individualOrAgent: String) =>
    ...
    s".amountReceivedForGrantOfLease for an $individualOrAgent" - {

      val fieldName = "amountReceivedForGrantOfLease"
