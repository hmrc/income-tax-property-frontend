...
class UkRentalPropertyIncomeFormProviderSpec extends CurrencyFieldBehaviours {

  val form = new UkRentalPropertyIncomeFormProvider()()

  ".ukRentalPropertyIncomeAmount" - {

    val fieldName = "ukRentalPropertyIncomeAmount"
    ...
    behave like currencyField(
      ...
      twoDecimalPlacesError = FormError(fieldName, "uKRentalPropertyIncome.error.twoDecimalPlaces")
    )
