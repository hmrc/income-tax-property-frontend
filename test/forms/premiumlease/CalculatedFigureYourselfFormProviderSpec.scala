  ...
  ".calculatedFigureYourselfAmount" - {
    "when calculatedFigureYourself is true" - {
      "and an amount is entered, should successfully bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "true", "calculatedFigureYourselfAmount" -> "4534.65"))
      ...
      "and no amount is entered, should fail to bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "true"))
      ...
      "and a non numeric value is entered then should fail to bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "true", "calculatedFigureYourselfAmount" -> "jdhfgdsgfzxmnbdv"))
      ...
      "and an amount is entered that has more than 2 decimal places then it should fail to bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "true", "calculatedFigureYourselfAmount" -> "4534.6545"))
      ...
      "and an amount is entered that is out of range then should fail to bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "true", "calculatedFigureYourselfAmount" -> "45334553534535345435345345434.65"))
    ...
    "when calculatedFigureYourself is false" - {
      "and an amount is entered, should successfully bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "false", "calculatedFigureYourselfAmount" -> "9967.00"))
        boundForm.value.value mustBe CalculatedFigureYourself(false, None)
        boundForm.errors mustBe empty
      }
      "and no amount is entered, should successfully bind" in {
        val boundForm = form.bind(Map("isCalculatedFigureYourself" -> "false"))
        boundForm.value.value mustBe CalculatedFigureYourself(false, None)
        boundForm.errors mustBe empty
      }
    }
