...
class StructureBuildingAllowanceClaimFormProviderSpec extends CurrencyFieldBehaviours {
  ...
  ".structureBuildingAllowanceClaim" - {

    val fieldName = "structureBuildingAllowanceClaim"
    ...
    behave like currencyField(
      form,
      fieldName,
      nonNumericError = FormError(fieldName, "structureBuildingAllowanceClaim.error.nonNumeric"),
