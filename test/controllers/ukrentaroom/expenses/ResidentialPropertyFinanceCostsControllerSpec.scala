...
class ResidentialPropertyFinanceCostsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val residentialPropertyFinanceCostsRoute =
    routes.ResidentialPropertyFinanceCostsController.onPageLoad(taxYear, NormalMode).url
  ...
  "ResidentialPropertyFinanceCosts Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ResidentialPropertyFinanceCostsPage, validAnswer).success.value
