...
import views.html.DoYouWantToRemoveCountryView
...
class DoYouWantToRemoveCountryControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val doYouWantToRemoveCountryRoute = routes.DoYouWantToRemoveCountryController.onPageLoad(NormalMode).url
