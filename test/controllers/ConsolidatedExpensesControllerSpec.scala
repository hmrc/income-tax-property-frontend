...
import pages.ConsolidatedExpensesPage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.ConsolidatedExpensesView
...
class ConsolidatedExpensesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val consolidatedExpensesRoute = routes.ConsolidatedExpensesController.onPageLoad(NormalMode).url
  ...
  "ConsolidatedExpenses Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ConsolidatedExpensesPage, true).success.value
