...
class ForeignOtherAllowablePropertyExpensesControllerSpec extends SpecBase with MockitoSugar {

  val formProvider = new ForeignOtherAllowablePropertyExpensesFormProvider()
  ...
  "ForeignOtherAllowablePropertyExpenses Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, foreignOtherAllowablePropertyExpensesRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, foreignOtherAllowablePropertyExpensesRoute)
            .withFormUrlEncodedBody(("otherAllowablePropertyExpensesAmount", validAnswer.toString))
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, foreignOtherAllowablePropertyExpensesRoute)
            .withFormUrlEncodedBody(("otherAllowablePropertyExpensesAmount", "invalid value"))

        val boundForm = form.bind(Map("otherAllowablePropertyExpensesAmount" -> "invalid value"))
