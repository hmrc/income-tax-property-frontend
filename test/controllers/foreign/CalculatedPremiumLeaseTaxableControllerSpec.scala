...
class CalculatedPremiumLeaseTaxableControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val calculatedPremiumLeaseTaxableRoute = routes.CalculatedPremiumLeaseTaxableController.onPageLoad(NormalMode).url
  ...
  "CalculatedPremiumLeaseTaxable Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(CalculatedPremiumLeaseTaxablePage, true).success.value
