...
import views.html.ConsolidatedRRExpensesView
...
class ConsolidatedRRExpensesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val consolidatedRRExpensesRoute = routes.ConsolidatedRRExpensesController.onPageLoad(taxYear, NormalMode).url
