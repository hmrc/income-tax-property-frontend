...
class MessagesSpec extends SpecBase {
  ...
  private val exclusionKeys: Set[String] = Set(
    ...
    "incomeFromPropertyRentals.para2.Rentals.agent",
    "incomeFromPropertyRentals.para2.Rentals.individual",
    "incomeFromPropertyRentals.para2.RentalsRentARoom.agent",
    "incomeFromPropertyRentals.para2.RentalsRentARoom.individual",
    "index.guidance",
    "index.heading",
    "index.title",
    "jointlyLet.title",
