...
class OtherAllowablePropertyExpensesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val OtherAllowablePropertyExpensesRoute: String = controllers.propertyrentals.expenses.routes.OtherAllowablePropertyExpensesController.onPageLoad(taxYear, NormalMode).url
