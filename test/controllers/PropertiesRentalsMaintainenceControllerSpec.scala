...
import views.html.RentsRatesAndInsuranceView
...
class RentsRatesAndInsuranceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val RentsRatesAndInsuranceRoute = routes.RentsRatesAndInsuranceController.onPageLoad(NormalMode).url
  ...
  "RentsRatesAndInsurance Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(RentsRatesAndInsurancePage, validAnswer).success.value
