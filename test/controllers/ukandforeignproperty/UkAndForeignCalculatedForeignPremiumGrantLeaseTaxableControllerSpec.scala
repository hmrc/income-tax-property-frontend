...
class UkAndForeignCalculatedForeignPremiumGrantLeaseTaxableControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute: Call = Call("GET", "/foo")

  val isAgentMessageKey = "individual"
  val formProvider = new UkAndForeignCalculatedForeignPremiumGrantLeaseTaxableFormProvider()
  ...
  "UkAndForeignCalculatedForeignPremiumGrantLeaseTaxable Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, ukAndForeignCalculatedForeignPremiumGrantLeaseTaxableRoute)
