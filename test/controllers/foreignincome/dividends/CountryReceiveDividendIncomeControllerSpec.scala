...
class CountryReceiveDividendIncomeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val countryReceiveDividendIncomeRoute = routes.CountryReceiveDividendIncomeController.onPageLoad(NormalMode).url
  ...
  "CountryReceiveDividendIncome Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(CountryReceiveDividendIncomePage, "answer").success.value
