...
import views.html.ForeignChangePIAExpensesView
...
class ForeignChangePIAExpensesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val foreignChangePIAExpensesRoute = routes.ForeignChangePIAExpensesController.onPageLoad(NormalMode).url
