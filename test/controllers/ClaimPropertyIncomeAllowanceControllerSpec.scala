...
import forms.ClaimPropertyIncomeAllowanceFormProvider
import models.{NormalMode, UserAnswers}
import navigation.{FakeNavigator, Navigator}
import org.mockito.ArgumentMatchers.any
import org.mockito.Mockito.when
import org.scalatestplus.mockito.MockitoSugar
import pages.ClaimPropertyIncomeAllowancePage
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.ClaimPropertyIncomeAllowanceView
...
class ClaimPropertyIncomeAllowanceControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val claimPropertyIncomeAllowanceRoute = routes.ClaimPropertyIncomeAllowanceController.onPageLoad(NormalMode).url
