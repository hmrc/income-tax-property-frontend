...
class OtherPropertyRRExpensesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val OtherPropertyRRExpensesRoute: String = controllers.routes.OtherPropertyRRExpensesController.onPageLoad(taxYear, NormalMode).url
  ...
  "OtherPropertyRRExpenses Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(OtherPropertyRRExpensesPage, validAnswer).success.value
