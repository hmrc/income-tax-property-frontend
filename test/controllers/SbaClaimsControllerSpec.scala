...
class SbaClaimsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val sbaClaimsRoute = routes.SbaClaimsController.onPageLoad(NormalMode).url
  ...
  "SbaClaims Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(SbaClaimsPage, true).success.value
