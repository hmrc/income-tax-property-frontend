...
class NavigatorSpec extends SpecBase {
  ...
  "Navigator" - {
    ...
    "in Check mode" - {
      ...
      "must go from RaRUnusedResidentialCostsPage to UnusedLossesBroughtForwardController" in {
        navigator.nextPage(
          ...
          UserAnswers("test"),
          UserAnswers("test")
        ) mustBe controllers.adjustments.routes.UnusedLossesBroughtForwardController
