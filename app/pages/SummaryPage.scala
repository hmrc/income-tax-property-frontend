...
import models.{ClaimExpensesOrRelief, NormalMode, PropertyType, RentARoom, Rentals, RentalsRentARoom, UKProperty, UKPropertySelect, UserAnswers}
...
case class SummaryPage(cyaDiversionService: CYADiversionService) {
  ...
  def rentalsAndRaRAllowancesItem(
    taxYear: Int,
    userAnswers: Option[UserAnswers]
  ) =
    TaskListItem(
