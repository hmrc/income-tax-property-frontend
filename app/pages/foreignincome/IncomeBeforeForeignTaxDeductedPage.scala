...
case class IncomeBeforeForeignTaxDeductedPage(countryCode: String) extends QuestionPage[BigDecimal] {

  override def path: JsPath = JsPath \ foreignDividendsPath(ForeignIncome) \ countryCode.toUpperCase \ toString

  override def toString: String = "incomeBeforeForeignTaxDeducted"
}
