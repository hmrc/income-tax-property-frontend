...
case class ForeignNonResidentialPropertyFinanceCostsPage(countryCode: String) extends QuestionPage[BigDecimal] {

  override def path: JsPath = JsPath \ foreignPropertyExpensesPath(ForeignProperty) \ countryCode.toUpperCase \ toString

  override def toString: String = "foreignNonResidentialPropertyFinanceCosts"
}
