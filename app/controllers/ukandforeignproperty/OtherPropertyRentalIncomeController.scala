...
import forms.ukandforeignproperty.UkAndForeignPropertyOtherIncomeFromPropertyFormProvider
import models.{Mode, UserAnswers}
import navigation.UkAndForeignPropertyNavigator
import pages.ukandforeignpropertyOtherIncomeFromPropertyPage
import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.{Action, AnyContent, MessagesControllerComponents}
import repositories.SessionRepository
import service.SessionService
import uk.gov.hmrc.play.bootstrap.frontend.controller.FrontendBaseController
import views.html.ukandforeignproperty.OtherIncomeFromPropertyView
...
class OtherPropertyRentalIncomeController @Inject()(
                                                     ...
                                                     formProvider: UkAndForeignPropertyOtherIncomeFromPropertyFormProvider,
  ...
  def onPageLoad(taxYear: Int, mode: Mode): Action[AnyContent] = (identify andThen getData) { implicit request =>
    ...
    val preparedForm =
      request.userAnswers.getOrElse(UserAnswers(request.userId)).get(OtherIncomeFromPropertyPage) match {
        case None        => form
        ...
        .fold(
          ...
          value =>
            for {
              ...
              navigator
                .nextPage(OtherIncomeFromPropertyPage, taxYear, mode, request.userAnswers, updatedAnswers)
            )
        )
  }
}
