...
object StructureBuildingAllowanceClaimSummary  {
  ...
  def row(taxYear: Int, answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(StructureBuildingAllowanceClaimPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.StructureBuildingAllowanceClaimController.onPageLoad(taxYear, CheckMode).url)
