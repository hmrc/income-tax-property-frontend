...
object ReplacementsOfDomesticGoodsSummary  {
  ...
  def row(taxYear: Int, answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(ReplacementsOfDomesticGoodsPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", controllers.ukrentaroom.routes.ReplacementsOfDomesticGoodsController.onPageLoad(taxYear, CheckMode).url)
