...
import pages.ukandforeignpropertye.OtherIncomeFromPropertyPage
    ...
    answers.get(OtherIncomeFromPropertyPage).map {
      answer =>
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.OtherPropertyRentalIncomeController.onPageLoad(taxYear, CheckMode).url)
