...
class UkAndForeignPropertyDeductingTaxFromNonUkResidentLandlordFormProvider @Inject() extends Mappings {
      ...
      "deductingTaxFromNonUkResidentLandlordAmount" -> {
        mandatoryIfTrue("deductingTaxFromNonUkResidentLandlordYesNo",
          currency(
            ...
            "ukAndForeignPropertyDeductingTaxFromNonUkResidentLandlord.error.nonNumeric")
