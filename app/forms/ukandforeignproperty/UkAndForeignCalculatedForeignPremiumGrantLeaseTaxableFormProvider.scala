...
class UkAndForeignCalculatedForeignPremiumGrantLeaseTaxableFormProvider @Inject() extends Mappings {
        ...
        "premiumsOfLeaseGrant" -> {
          mandatoryIfTrue(
            ...
            currency(
              ...
              s"ukAndForeignCalculatedForeignPremiumGrantLeaseTaxable.amount.error.nonNumeric.${individualOrAgent}"
            )
