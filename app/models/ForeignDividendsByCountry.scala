...
case object ForeignDividendsByCountry
  ...
  implicit val format: Format[ForeignDividendsByCountry] = Json.format[ForeignDividendsByCountry]
...
case class ReadForeignDividendsByCountry(countryCode: String) extends Gettable[ForeignDividendsByCountry] {
  implicit val format: Format[ForeignDividendsByCountry] = Json.format[ForeignDividendsByCountry]
