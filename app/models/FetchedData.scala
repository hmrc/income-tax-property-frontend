...
final case class FetchedData(
  ...
  incomeData: Option[FetchedForeignIncomeData]
)
...
final case class FetchedPropertyData(
  ukPropertyData: Option[FetchedUKPropertyData],
  foreignPropertyData: Option[FetchedForeignPropertyData],
  ukAndForeignPropertyData: Option[FetchedUkAndForeignPropertyData]
)
