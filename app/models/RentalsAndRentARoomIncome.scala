...
object RentalsAndRentARoomIncome extends Gettable[RentalsAndRentARoomIncome] with Settable[RentalsAndRentARoomIncome] {

  implicit val formats: Format[RentalsAndRentARoomIncome] = Json.format[RentalsAndRentARoomIncome]

  override def path: JsPath = JsPath \ toString

  override def toString: String = incomePath(RentalsRentARoom)
}
