...
case class PropertyRentalExpense(
...
case object PropertyRentalExpense extends Gettable[PropertyRentalExpense] {

  implicit val formats: Format[PropertyRentalExpense] = Json.format[PropertyRentalExpense]
