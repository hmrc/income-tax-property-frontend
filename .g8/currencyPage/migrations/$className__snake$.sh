...
echo "GET        /:taxYear/$className;format="camel"$                               controllers.$className$Controller.onPageLoad(taxYear: Int, mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /:taxYear/$className;format="camel"$                               controllers.$className$Controller.onSubmit(taxYear: Int, mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /:taxYear/change-$className;format="camel"$                        controllers.$className$Controller.onPageLoad(taxYear: Int, mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /:taxYear/change-$className;format="camel"$                        controllers.$className$Controller.onSubmit(taxYear: Int, mode: Mode = CheckMode)" >> ../conf/app.routes
